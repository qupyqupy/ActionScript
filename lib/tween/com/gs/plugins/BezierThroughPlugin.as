...
DESCRIPTION:
	...
	than using control points. Simply pass as many objects in the bezier Array as you'd like, one for each point through which the values should travel. For example, if you want the
